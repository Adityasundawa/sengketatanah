    ...
    <div class="container">
        ...
        <div class="row justify-content-center mb-2">
            ...
            <div class="col-lg-12">
                ...
                <div class="card border-0 mb-2 mt-2" style="z-index:999">
                        ...
                        <div class="card mb-2">
                            ...
                            <table class="mt-2 mb-2" style="width:100%">
                                <tr>
                                    ...
                                    <td class="align-items-center" rowspan="2">
                                        <button class="btn float-end" style="background: #E6B325; color: #fff"
                                            data-bs-toggle="modal" data-bs-target="#exampleSponsor">Ikut Lelang</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-start">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col text-center">
                                    <span onclick="return document.querySelector('form.form-sengketa1').submit()"
                                        class="btn btn-success rounded-5" style="cursor:pointer"><i
                                            class="fa-solid fa-play text-white"></i>
                                        Lihat Video</span>
                                </div>
