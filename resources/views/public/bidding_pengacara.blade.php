        ...
        <div class="row justify-content-center mb-2">
            <div class="col-lg-12 mb-2">
                <div class="row g-2 desktop mt-2">
                    ...
                    <div class="col-auto">
                        <a class="btn" style="background-color: #A47E3B; color: #fff" href="{{url('')}}/join">Pelajari Bid Pengacara</a>
                    </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-6 mobile">
                        <div class="ms-1 d-grid ">
                            <a class="btn btn-sm fw-bold btn-outline-brown rounded-5" href="{{url('')}}/join">Pelajari Bid Pengacara</a>
                        </div>
                    </div>
                </div>
            </div>
