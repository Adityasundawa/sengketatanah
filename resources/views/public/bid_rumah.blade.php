...
<body>
    ...
    <div class="container">
        ...
        <div class="col-lg-12 mt-3">
            <div class="card border-0 shadow-sm desktop" style="margin-top:-10px">
                                        ...
                                        <div class="desktop-2">
                                            <div id="carouselExampleControls{{$bs['id']}}" class="carousel slide"
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img src="{{asset('')}}{{$bs['img-rumah']}}"
                                                            class="d-block w-100"
                                                            style="height:250px;width:auto;object-fit:cover">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="{{asset('')}}{{$bs['img-rumah1']}}"
                                                            class="d-block w-100"
                                                            style="height:250px;width:auto;object-fit:cover">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="{{asset('')}}{{$bs['img-rumah2']}}"
                                                            class="d-block w-100"
                                                            style="height:250px;width:auto;object-fit:cover">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="{{asset('')}}{{$bs['img-rumah3']}}"
                                                            class="d-block w-100"
                                                            style="height:250px;width:auto;object-fit:cover">
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                <div class="col mobile-scroll" id='orang-notaris' style="white-space:nowrap;flex-wrap:nowarp;display:flex">
                                    ...
                                    @for($i=13;$i> 0;$i--)
                                        ...
                                        <button class="container-gambar text-center p-1 me-1 text-decoration-none border-0 bg-white"
                                            onclick="return  $('form#form-notaris-<?= $i ?>').submit()" style='display: inline-block;flex: 0 0 auto'>
                                            <img src="https://randomuser.me/api/portraits/men/{{$i}}.jpg" alt="" srcset=""
                                                class="rounded-4 img-thumbnail " style="width:70px !important;height:70px;object-fit:cover;"> <br>
                                            {{$name[$i]}}
                                        </button>
                                    @endfor
                            ...
                            <div class="row">
                                <div class="col mobile-scroll" id='orang-ukur' style="white-space:nowrap;flex-wrap:nowarp;display:flex">
                                    ...
                                    @for($i=0;$i< 14;$i++)
                                        ...
                                        <button class=" mb-0 container-gambar text-center p-1 me-1 text-decoration-none border-0 bg-white"
