...
<body>
        ...
        <div class="row justify-content-center mb-2">
            ...
            <div class="col-lg-12 desktop mb-2">
                <div class="row g-2 mt-2">
                    ...
                    <div class="col-auto">
                        <a class="btn" style="background-color: #A47E3B; color: #fff" href="{{url('')}}/join">Pelajari Bid Rumah</a>
                    </div>
            ...
            <div class="row g-0 justify-content-center">
                ...
                <div class="col">
                    <div class="ms-1 d-grid ">
                        <a class="btn btn-sm fw-bold btn-outline-brownie rounded-5" href="{{url('')}}/join">Pelajari Bid Rumah</a>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-items-center" rowspan="2">
                                                    ...
                                                    <div class="row d-flex  align-items-center mb-2">
                                                        ...
                                                        <div class="col">
                                                            <button class="btn float-end btn-warning text-white mb-0" data-bs-toggle="modal" data-bs-target="#bdm-rumah">
                                                                &nbsp;&nbsp;&nbsp;Bid&nbsp;&nbsp;&nbsp;</button>
                                                        </div>
                                                    </div>
                                                    <script>
                            ...
                            <div class="col-md-4 mb-3 {{$bs['kode_objek']}}">
                                <div class="card mb-2">
                                    ...
                                    <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h5 class="mb-0 text-center">Kode Objek BR-004 <img src="{{asset('')}}uploads/biru_centang.png" alt="" class="mb-1" style="height:20px"></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <table class="mt-2 mb-2 w-100">
    ...
    <div class="modal fade my-auto" id="bdm-rumah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header p-0">
                    <h1 class="modal-title mx-auto text-danger display-1">
