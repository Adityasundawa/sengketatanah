                                ...
                                <div class="card mb-2">
                                    ...
                                    <div class="desktop-2">
                                        <div id="carouselExampleControls{{$bs['id']}}" class="carousel slide"
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img src="{{asset('')}}{{$bs['img-rumah']}}" class="d-block w-100"
                                                        style="height:250px;width:auto;object-fit:cover">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{asset('')}}{{$bs['img-rumah1']}}" class="d-block w-100"
                                                        style="height:250px;width:auto;object-fit:cover">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{asset('')}}{{$bs['img-rumah2']}}" class="d-block w-100"
                                                        style="height:250px;width:auto;object-fit:cover">
                                                </div>
                                                <div class="carousel-item">
                                                    <img src="{{asset('')}}{{$bs['img-rumah3']}}" class="d-block w-100"
                                                        style="height:250px;width:auto;object-fit:cover">
                                                </div>
                                            </div>
                                            <button class="carousel-control-prev opacity-90 text-dark" type="button"
