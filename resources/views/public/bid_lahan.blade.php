                                    ...
                                    <div class="col-md-4 mb-3 {{$bs['kode_objek']}}">
                                        <div class="card mb-2">
                                            ...
                                            <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <h5 class="mb-0 text-center">Kode Bidang BL-00{{$bs['id']}}
                                ...
                                <div class="col-md-4 mb-3 {{$bs['kode_objek']}}">
                                    <div class="card mb-2">
                                        ...
                                        <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <h5 class="mb-0 text-center">Kode Bidang BL-004 <img src="{{asset('')}}uploads/biru_centang.png" alt="" class="mb-1" style="height:20px"></h5>
                                                </div>
                                            </div>
                                        </div>
                                        <table class="mt-2 mb-2 w-100">
