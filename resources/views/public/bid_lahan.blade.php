        ...
        <div class="row justify-content-center mb-2">
                                            ...
                                            <div class="desktop-2">
                                                <div id="carouselExampleControls{{$bs['id']}}" class="carousel slide"
                                                    ...
                                                    <div class="carousel-inner">
                                                        ...
                                                        <div class="carousel-item">
                                                            <img src="{{asset('')}}{{$bs['img1']}}"
                                                                class="d-block w-100"
                                                                style="height:250px;width:auto;object-fit:cover">
                                                        </div>
                                                        <div class="carousel-item">
                                                            <img src="{{asset('')}}{{$bs['img2']}}"
                                                                class="d-block w-100"
                                                                style="height:250px;width:auto;object-fit:cover">
                                                        </div>
                                                        <div class="carousel-item">
                                                            <img src="{{asset('')}}{{$bs['img3']}}"
                                                                class="d-block w-100"
                                                                style="height:250px;width:auto;object-fit:cover">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="modal fade my-auto" id="exampleSponsor"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        Anda harus memiliki akun LENDER sebelum
                                                                        melakukan
            ...
            <div class="card mt-3 border-0 shadow-sm">
                <div class="card-body">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-1 arrow-desktop text-center">
                            <button id="left-orang-ppat" class="btn rounded-5 text-white bg-secondary"
                                style="background-color: #61481C">
                                <i class="fa-solid fa-arrow-left"></i>
                            </button>
                        </div>
                        ...
                        <div class="col-1 arrow-desktop text-center">
                            <button id="right-orang-ppat" class="btn rounded-5 text-white bg-secondary"
                                style="background-color: #61481C">
                                <i class="fa-solid fa-arrow-right"></i>
                            </button>
                        </div>
            ...
            <div class="card mt-3 border-0 shadow-sm">
                <div class="card-body">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-1 arrow-desktop text-center">
                            <button id="left-orang-notaris" class="btn rounded-5 text-white bg-secondary"
                                style="background-color: #61481C">
                                <i class="fa-solid fa-arrow-left"></i>
                            </button>
                        </div>
                        ...
                        <div class="col-1 arrow-desktop text-center">
                            <button id="right-orang-notaris" class="btn rounded-5 text-white bg-secondary"
                                style="background-color: #61481C">
                                <i class="fa-solid fa-arrow-right"></i>
                            </button>
                        </div>
            ...
            <div class="card mt-3 border-0 shadow-sm">
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-1 arrow-desktop text-center">
                            <button id="left-orang-ukur" class="btn rounded-5 text-white bg-secondary mt-4"
                                style="background-color: #61481C">
                                <i class="fa-solid fa-arrow-left"></i>
                            </button>
                        </div>
                        ...
                        <div class="col-1 arrow-desktop text-center">
                            <button id="right-orang-ukur" class="btn rounded-5 text-white bg-secondary mt-4"
                                style="background-color: #61481C">
                                <i class="fa-solid fa-arrow-right"></i>
                            </button>
                        </div>
            ...
            <div class="row justify-content-center mb-3 mt-4 text-center g-0">
                ...
                <div class="modal fade" id="korbanSengketaModal" tabindex="-1"
                    aria-labelledby="korbanSengketaModalLabel" aria-hidden="true">
