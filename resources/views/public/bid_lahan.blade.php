                                ...
                                <div class="col mb-4">
                                    <a href="{{url('/')}}/kerjasama-lahan"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                            ...
                                            xml:space="preserve" class="">
                                            <circle r="255.99996" cx="255.99996" cy="255.5" fill="#ffffff"
                                                shape="circle">
                                            </circle>
                                ...
                                <div class="col mb-4">
                                    <a href="{{url('/')}}/advokasi-pemerintah"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                            xmlns:svgjs="http://svgjs.com/svgjs" width="85px" x="0" y="0"
                                            viewBox="0 0 512 511" style="enable-background:new 0 0 512 512"
                                            xml:space="preserve" class="">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h5 class="mb-0 text-center">Kode Bidang BL-00{{$bs['id']}}
                                                    <img src="{{asset('')}}uploads/biru_centang.png" alt="" class="mb-1"
                                                        style="height:20px">
                                                </h5>
                                            </div>
                                        </div>
