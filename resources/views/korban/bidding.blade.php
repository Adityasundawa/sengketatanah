                                        ...
                                        <div class="card radius-10">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="text-primary ms-auto font-35"><svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                                        width="50px" x="0" y="0" viewBox="0 0 50 60"
                                            ...
                                            <g xmlns="http://www.w3.org/2000/svg" id="Page-1" fill="none"
                                                ...
                                                <g id="001---Bid-Sign" fill="rgb(0,0,0)" fill-rule="nonzero">
                                                    <path id="Shape"
                                                        ...
                                                        fill="#17a00e" data-original="#000000" class=""></path>
                                                    <path id="Shape"
