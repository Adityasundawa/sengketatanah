                                        ...
                                        <div class="card mb-2 mx-auto">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col text-center">
                                                        <span onclick="return document.querySelector('form.form-sengketa3').submit()" class="btn btn-success rounded-5" style="cursor:pointer"><i class="fa-solid fa-play text-white"></i>
                                                            Lihat Podcast</span>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-lg-10">
                                    <div class="row">
                                        <div class="col mobile-scroll" id='orang-kotak' style="white-space:nowrap;flex-wrap:nowarp;display:flex">
                                            ...
                                            <button class="container-gambar text-center p-1 me-1 text-decoration-none border-0 bg-white" onclick="return  $('form#form-Lawyer-<?= $i ?>').submit()" style='display: inline-block;flex: 0 0 auto'>
                                            ...
                                            <div style='display: inline-block;flex: 0 0 auto;' class="ms-3">
                                                <a href="{{url('')}}/list-tukang" class="container-gambar text-center" style="text-decoration: none;">
                                ...
                                <div class="col-lg-10">
                                    <div class="row">
                                        <div class="col mobile-scroll" id='orang-bulet' style="white-space:nowrap;flex-wrap:nowarp;display:flex">
                                            ...
                                            ?>
                                            <button class="container-gambar text-center p-1 me-1 text-decoration-none border-0 bg-white" style='display: inline-block;flex: 0 0 auto' onclick="return window.location.href = `{{url('')}}/list-tukang`">
                                            ...
                                            @for($i=0;$i< 14;$i++)<form action="{{url('')}}/detail-petugas" method="get" id="form-ukur-{{$i}}">
                                                ...
                                                <button class="container-gambar text-center p-1 me-1 text-decoration-none border-0 bg-white" onclick="return  $('form#form-ukur-<?= $i ?>').submit()" style='display: inline-block;flex: 0 0 auto'>
                                                    <img src="https://randomuser.me/api/portraits/men/{{$i}}.jpg" alt="" srcset="" class="rounded-circle img-thumbnail " style="width:70px !important;height:70px;object-fit:cover;"> <br>
                                                    {{$name[$i]}}
                                                </button>
                ...
                <div class="card mb-4 border-0 shadow-sm ">
                    ...
                    <div class="card-body" style="background-color:#FAFAD2;">
                        ...
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-1 arrow-desktop text-center">
                                <button id="left-button-bid-lahan" class="btn rounded-5 text-white bg-secondary" style="background-color: #61481C;">
                                    <i class="fa-solid fa-arrow-left"></i>
                                </button>
                            </div>
                            ...
                            <div class="col-10 desktop-arrow text-center">
                                ...
                                <div class="row mobile-scroll justify-content-between" id="bid-lahan-card" style="flex-wrap: nowrap">
                                    ...
                                    <div class="col-12 custom ">
                                        <div class="card mx-auto">
                                            ...
                                            <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <h5 class="mb-0 text-center">Kode Bidang BL-004 <img src="https://sengketatanah.id/uploads/biru_centang.png" alt="" class="mb-1" style="height:20px"></h5>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td rowspan="2">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <button class="btn float-end btn-info text-white mb-0 my-auto w-100" data-bs-toggle="modal" data-bs-target="#exampleC">
                                                                    BID</button>
                                                            </div>
                                        ...
                                        <div class="card mb-2 mx-auto">
                                            ...
                                            <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <h5 class="mb-0 text-center">Kode Bidang BL-001 <img src="{{asset('')}}uploads/biru_centang.png" alt="" class="mb-1" style="height:20px"></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card mb-2 mx-auto">
                                            ...
                                            <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <h5 class="mb-0 text-center">Kode Bidang BL-002 <img src="{{asset('')}}uploads/biru_centang.png" alt="" class="mb-1" style="height:20px"></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card mb-2 mx-auto">
                                            ...
                                            <div class="card-header text-white px-3 py-1" style="background: #8f8f8f">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <h5 class="mb-0 text-center">Kode Bidang BL-003 <img src="{{asset('')}}uploads/biru_centang.png" alt="" class="mb-1" style="height:20px"></h5>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-1 arrow-desktop text-center">
                                <button id="right-button-bid-lahan" class="btn rounded-5 text-white bg-secondary" style="background-color: #61481C">
                                    <i class="fa-solid fa-arrow-right"></i>
                                </button>
                            </div>
                                ...
                                <div class="col-lg-10">
                                    <div class="row">
                                        <div class="col mobile-scroll" id='orang-kotak2' style="white-space:nowrap;flex-wrap:nowarp;display:flex">
                                            ...
                                            <button class="container-gambar text-center p-1 me-1 text-decoration-none border-0 bg-white" onclick="return  $('form#form-ppat-<?= $i ?>').submit()" style='display: inline-block;flex: 0 0 auto'>
