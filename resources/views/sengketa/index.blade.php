...
<body>
    ...
    <div class="card fixed-bottom rounded-0">
        <div class="card-body p-0">
            <div class="row justify-content-between text-center scroll-simple g-0"
                style="overflow-x: auto; flex-wrap: nowrap">
                <div class="col">
                    <a href="{{url('/')}}/bid-sengketa"
                        class="btn btn-outline-light text-dark w-100 rounded-0 h-100">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                            width="51px" x="0" y="0" viewBox="0 0 50 60"
                ...
                <div class="col">
                    <a href="{{url('/')}}/jual-beli-lahan"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                            width="65px" x="0" y="0" viewBox="0 0 64 64"
                            style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                ...
                <div class="col">
                    <a href="{{url('/')}}/kerjasama-lahan"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                            width="65px" x="0" y="0" viewBox="0 0 511.99992 511"
                            style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                ...
                <div class="col">
                    <a href="{{url('/')}}/lelang-lahan"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                            width="65px" x="0" y="0" viewBox="0 0 479.976 479.976"
                            style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                ...
                <div class="col">
                    <a href="{{url('/')}}/jasa-tukang-ukur"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                            width="57px" x="0" y="0" viewBox="0 0 54 60"
                            style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                        ...
                        <div class="mt-0" style="font-size: 11px">Jasa Tukang Ukur</div>
                    </a>
                </div>
                <div class="col">
                    <a href="{{url('/')}}/bidding-pengacara"
                ...
                <div class="col">
                    <a href="{{url('/')}}/jasa-notaris"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                            width="65px" x="0" y="0" viewBox="0 0 512 512"
                            style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
