                                    ...
                                    <div class="row">
                                        <div class="col mobile-scroll" id='orang-kotak'
                                            ...
                                            <div class="container-gambar text-center ms-1"
                                                ...
                                                onclick="return window.location.href = `{{url('')}}/list-tukang`">
                                            ...
                                            <div style='display: inline-block;flex: 0 0 auto;' class="ms-3">
                                                <a href="{{url('')}}/list-tukang" class="container-gambar text-center"
                                                    style="text-decoration: none;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row g-0 align-items-center">
                                                    <div class="col text-center">
                                                        ...
                                                        <div class="modal fade my-auto" id="berkasPengacara"
                                                            tabindex="-1" aria-labelledby="exampleModalLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-items-center">
                                                        ...
                                                        <div class="row d-flex  align-items-center mb-2">
                                                            ...
                                                            <div class="col">
                                                                <button class="btn float-end btn-danger mb-0"
                                                                    data-bs-toggle="modal" data-bs-target="#exampleA">
                                                                    &nbsp;&nbsp;&nbsp;Bid&nbsp;&nbsp;&nbsp;</button>
                                                            </div>
                                                        </div>
                                                        <script>
                                            ...
                                            <div class="row g-0">
                                                <div class="col text-start">
                                                    ...
                                                    <div class="modal fade my-auto text-center" id="berkasA"
                                                        tabindex="-1" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="row g-0">
                                                <div class="col text-start">
                                                    ...
                                                    <div class="modal fade my-auto text-center" id="berkasB"
                                                        tabindex="-1" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
