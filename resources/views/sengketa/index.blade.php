...
<body>
    ...
    <div class="container card aboute-bottom rounded-0">
                    ...
                    <div class="col text-center">
                        ...
                        <div class="card rounded-0">
                            <div class="card-body p-2">
                                ...
                                <h6 class="mt-1" style="font-size: 12px">HOME</h6>
                            </div>
                        </div>
                        </button>
                    </div>
                    ...
                    <div class="col text-center">
                        ...
                        <div class="card rounded-0">
                            <div class="card-body p-2">
                                ...
                                <h6 class="mt-1" style="font-size: 12px">PANDUAN</h6>
                            </div>
                        </div>
                        </button>
                    ...
                    <div class="col text-center">
                        <button class="btn btn-sm mb-0 p-0 w-100" id="btn-jaminan" type="button">
                            <div class="card rounded-0">
                                ...
                                <h6 class="mt-1" style="font-size: 12px">JAMINAN</h6>
                            </div>
                        </button>
                        ...
                        <button class="btn btn-sm mb-0 p-0 w-100" id="btn-chat" type="button">
                            <div class="card rounded-0">
                                <div class="card-body p-2">
                                    ...
                                    <h6 class=" mb-1" style="font-size: 12px;margin-top:13px">CHAT</h6>
                                </div>
                            </div>
                        </button>
                        ...
                        <button class="btn btn-sm mb-0 p-0 w-100" id="btn-tentang" type="button">
                            <div class="card rounded-0">
                                <div class="card-body p-2">
                                    ...
                                    <h6 class="mt-1" style="font-size: 12px">TENTANG</h6>
                                </div>
                            </div>
                        </button>
