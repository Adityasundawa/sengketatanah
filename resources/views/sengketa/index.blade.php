...
<body>
    ...
    <div class="container">
        ...
        <div class="card mb-3 mt-2 border-0 shadow-sm desktop" style="margin-top:-10px;display:none">
            <div class="card-body pb-1 pt-2">
                ...
                <div class="col-2 text-center">
                    <button class="btn btn-sm" id="btn-tentang" type="button" style="margin-left:-10px">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
                            xmlns:svgjs="http://svgjs.com/svgjs" width="70px" x="0" y="0" viewBox="0 0 24 24"
                            style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                            <circle r="12" cx="12" cy="12" fill="#ffffff" shape="circle"></circle>
                            <g transform="matrix(0.7,0,0,0.7,3.600000000000003,3.600000000000003)">
                                <g xmlns="http://www.w3.org/2000/svg" fill="rgb(0,0,0)">
                                    <path
                                        d="m12 0a12 12 0 1 0 12 12 12.013 12.013 0 0 0 -12-12zm0 22a10 10 0 1 1 10-10 10.011 10.011 0 0 1 -10 10z"
                                        fill="#61481c" data-original="#000000" class=""></path>
                                    <path d="m12 9a1 1 0 0 0 -1 1v8a1 1 0 0 0 2 0v-8a1 1 0 0 0 -1-1z" fill="#61481c"
                                        data-original="#000000" class=""></path>
                ...
                <ol id="chat" class="list-group list-group-numbered shadow dropdown-menu rounded-0 p-3 text-center"
                    style="inset: auto auto 0px 0px; margin: 0px; border-top: none">
                    <h2>
                        <div class="fw-bold" style="color: #61481C"> Customer Service</div>
                    </h2>
                            ...
                            <div class="card mx-auto">
                                ...
                                <div id="bidding1" class="carousel slide" data-bs-interval="false">
                                    <div class="carousel-indicators">
                                        <button type="button" data-bs-target="#bidding1" data-bs-slide-to="0"
                                            class="active" aria-current="true" aria-label="Slide 1"></button>
                                        <button type="button" data-bs-target="#bidding1" data-bs-slide-to="1"
                                            aria-label="Slide 2"></button>
                                        <button type="button" data-bs-target="#bidding1" data-bs-slide-to="2"
                                            aria-label="Slide 3"></button>
                                        <button type="button" data-bs-target="#bidding1" data-bs-slide-to="3"
                        ...
                        <div class="col-12 custom">
                            <div class="card mb-2 mx-auto">
                                ...
                                <div id="bidding2" class="carousel slide" data-bs-interval="false">
                                    <div class="carousel-indicators">
                                        <button type="button" data-bs-target="#bidding2" data-bs-slide-to="0"
                                            class="active" aria-current="true" aria-label="Slide 1"></button>
                                        <button type="button" data-bs-target="#bidding2" data-bs-slide-to="1"
                                            aria-label="Slide 2"></button>
                                        <button type="button" data-bs-target="#bidding2" data-bs-slide-to="2"
                                            aria-label="Slide 3"></button>
                                        <button type="button" data-bs-target="#bidding2" data-bs-slide-to="3"
                                            aria-label="Slide 4"></button>
                                    </div>
                                    ...
                                    <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding2" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding2" data-bs-slide="next">
                                        <span class="carousel-control-next-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Next</span>
                                    </button>
                        ...
                        <div class="col-12 custom">
                            <div class="card mb-2 mx-auto">
                                ...
                                <div id="bidding3" class="carousel slide" data-bs-interval="false">
                                    <div class="carousel-indicators">
                                        <button type="button" data-bs-target="#bidding3" data-bs-slide-to="0"
                                            class="active" aria-current="true" aria-label="Slide 1"></button>
                                        <button type="button" data-bs-target="#bidding3" data-bs-slide-to="1"
                                            aria-label="Slide 2"></button>
                                        <button type="button" data-bs-target="#bidding3" data-bs-slide-to="2"
                                            aria-label="Slide 3"></button>
                                        <button type="button" data-bs-target="#bidding3" data-bs-slide-to="3"
                                            aria-label="Slide 4"></button>
                                    </div>
                                    ...
                                    <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding3" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding3" data-bs-slide="next">
                                        <span class="carousel-control-next-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Next</span>
                                    </button>
                        ...
                        <div class="col-12 custom">
                            <div class="card mb-2 mx-auto">
                                ...
                                <div id="bidding4" class="carousel slide" data-bs-interval="false">
                                    <div class="carousel-indicators">
                                        <button type="button" data-bs-target="#bidding4" data-bs-slide-to="0"
                                            class="active" aria-current="true" aria-label="Slide 1"></button>
                                        <button type="button" data-bs-target="#bidding4" data-bs-slide-to="1"
                                            aria-label="Slide 2"></button>
                                        <button type="button" data-bs-target="#bidding4" data-bs-slide-to="2"
                                            aria-label="Slide 3"></button>
                                        <button type="button" data-bs-target="#bidding4" data-bs-slide-to="3"
                                            aria-label="Slide 4"></button>
                                    </div>
                                    ...
                                    <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding4" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding4" data-bs-slide="next">
                                        <span class="carousel-control-next-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Next</span>
                                    </button>
                        ...
                        <div class="col-12 custom ">
                            <div class="card mx-auto">
                                ...
                                <div id="bidding1-1" class="carousel slide" data-bs-interval="false">
                                    <div class="carousel-indicators">
                                        <button type="button" data-bs-target="#bidding1-1" data-bs-slide-to="0"
                                            class="active" aria-current="true" aria-label="Slide 1"></button>
                                        <button type="button" data-bs-target="#bidding1-1" data-bs-slide-to="1"
                                            aria-label="Slide 2"></button>
                                        <button type="button" data-bs-target="#bidding1-1" data-bs-slide-to="2"
                                            aria-label="Slide 3"></button>
                                        <button type="button" data-bs-target="#bidding1-1" data-bs-slide-to="3"
                                            aria-label="Slide 4"></button>
                                    </div>
                                    ...
                                    <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding1-1" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding1-1" data-bs-slide="next">
                                        <span class="carousel-control-next-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Next</span>
                                    </button>
                        ...
                        <div class="col-12 custom">
                            <div class="card mb-2 mx-auto">
                                ...
                                <div id="bidding1-2" class="carousel slide" data-bs-interval="false">
                                    <div class="carousel-indicators">
                                        <button type="button" data-bs-target="#bidding1-2" data-bs-slide-to="0"
                                            class="active" aria-current="true" aria-label="Slide 1"></button>
                                        <button type="button" data-bs-target="#bidding1-2" data-bs-slide-to="1"
                                            aria-label="Slide 2"></button>
                                        <button type="button" data-bs-target="#bidding1-2" data-bs-slide-to="2"
                                            aria-label="Slide 3"></button>
                                        <button type="button" data-bs-target="#bidding1-2" data-bs-slide-to="3"
                                            aria-label="Slide 4"></button>
                                    </div>
                                    ...
                                    <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding1-2" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding1-2" data-bs-slide="next">
                                        <span class="carousel-control-next-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Next</span>
                                    </button>
                        ...
                        <div class="col-12 custom">
                            <div class="card mb-2 mx-auto">
                                ...
                                <div id="bidding1-3" class="carousel slide" data-bs-interval="false">
                                    <div class="carousel-indicators">
                                        <button type="button" data-bs-target="#bidding1-3" data-bs-slide-to="0"
                                            class="active" aria-current="true" aria-label="Slide 1"></button>
                                        <button type="button" data-bs-target="#bidding1-3" data-bs-slide-to="1"
                                            aria-label="Slide 2"></button>
                                        <button type="button" data-bs-target="#bidding1-3" data-bs-slide-to="2"
                                            aria-label="Slide 3"></button>
                                        <button type="button" data-bs-target="#bidding1-3" data-bs-slide-to="3"
                                            aria-label="Slide 4"></button>
                                    </div>
                                    ...
                                    <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding1-3" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding1-3" data-bs-slide="next">
                                        <span class="carousel-control-next-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Next</span>
                                    </button>
                        ...
                        <div class="col-12 custom">
                            <div class="card mb-2 mx-auto">
                                ...
                                <div id="bidding1-4" class="carousel slide" data-bs-interval="false">
                                    <div class="carousel-indicators">
                                        <button type="button" data-bs-target="#bidding1-4" data-bs-slide-to="0"
                                            class="active" aria-current="true" aria-label="Slide 1"></button>
                                        <button type="button" data-bs-target="#bidding1-4" data-bs-slide-to="1"
                                            aria-label="Slide 2"></button>
                                        <button type="button" data-bs-target="#bidding1-4" data-bs-slide-to="2"
                                            aria-label="Slide 3"></button>
                                        <button type="button" data-bs-target="#bidding1-4" data-bs-slide-to="3"
                                            aria-label="Slide 4"></button>
                                    </div>
                                    ...
                                    <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding1-4" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next opacity-90 text-dark" type="button"
                                        data-bs-target="#bidding1-4" data-bs-slide="next">
                                        <span class="carousel-control-next-icon bg-dark rounded-circle"
                                            aria-hidden="true"></span>
                                        <span class="visually-hidden">Next</span>
                                    </button>
                        ...
                        <div class="col-12 custom ">
                            <div class="card mx-auto">
                                ...
                                <div class="card-header bg-pengacara text-white px-3 py-1">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h5 class="mb-0 text-center">Kode Bid BP-001 <img
                                                    src="{{asset('')}}uploads/biru_centang.png" alt="" class="mb-1"
                                                    style="height:20px">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-center g-0" style="margin-top:-15px;">
                                        <div class="col-4">
                                            ...
                                            <div class="d-grid gap-2 ">
                                                ...
                                                <div class="modal fade my-auto" id="examplePengacara" tabindex="-1"
                                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header p-0">
    ...
    <div class="card-body bg-card-dark-mode">
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-1 arrow-desktop text-center">
                <button id="left-button2" class="btn rounded-5 text-white bg-secondary"
                    style="background-color: #61481C">
                    <i class="fa-solid fa-arrow-left"></i>
                </button>
            </div>
                    ...
                    <div class="col-12 custom ">
                        <div class="card mx-auto">
                            ...
                            <div id="jbl1" class="carousel slide" data-bs-interval="false">
                                <div class="carousel-indicators">
                                    <button type="button" data-bs-target="#jbl1" data-bs-slide-to="0" class="active"
                                ...
                                <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                    data-bs-target="#jbl1" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next opacity-90 text-dark" type="button"
                                    data-bs-target="#jbl1" data-bs-slide="next">
                                    <span class="carousel-control-next-icon bg-dark rounded-circle"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Next</span>
                                </button>
                                ...
                                <div class="row justify-content-center g-0" style="margin-top:-15px;">
                                    <div class="col-4">
                                        ...
                                        <div class="d-grid gap-2 ">
                                            ...
                                            <div class="modal fade my-auto" id="exampleB" tabindex="-1"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header p-0">
                    ...
                    <div class="col-12 custom">
                        <div class="card mb-2 mx-auto">
                            ...
                            <div id="jbl2" class="carousel slide" data-bs-interval="false">
                                <div class="carousel-indicators">
                                    <button type="button" data-bs-target="#jbl2" data-bs-slide-to="0" class="active"
                                        aria-current="true" aria-label="Slide 1"></button>
                    ...
                    <div class="col-12 custom">
                        <div class="card mb-2 mx-auto">
                            ...
                            <div id="jbl3" class="carousel slide" data-bs-interval="false">
                                <div class="carousel-indicators">
                                    <button type="button" data-bs-target="#jbl3" data-bs-slide-to="0" class="active"
                                        aria-current="true" aria-label="Slide 1"></button>
                                ...
                                <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                    data-bs-target="#jbl3" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next opacity-90 text-dark" type="button"
                                    data-bs-target="#jbl3" data-bs-slide="next">
                                    <span class="carousel-control-next-icon bg-dark rounded-circle"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Next</span>
                                </button>
                    ...
                    <div class="col-12 custom">
                        <div class="card mb-2 mx-auto">
                            ...
                            <div id="jbl4" class="carousel slide" data-bs-interval="false">
                                <div class="carousel-indicators">
                                    <button type="button" data-bs-target="#jbl4" data-bs-slide-to="0" class="active"
                                        aria-current="true" aria-label="Slide 1"></button>
                                ...
                                <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                    data-bs-target="#jbl4" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next opacity-90 text-dark" type="button"
                                    data-bs-target="#jbl4" data-bs-slide="next">
                                    <span class="carousel-control-next-icon bg-dark rounded-circle"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Next</span>
                                </button>
            ...
            <div class="col-1 arrow-desktop text-center">
                <button id="right-button2" class="btn rounded-5 text-white bg-secondary"
                    style="background-color: #61481C">
                    <i class="fa-solid fa-arrow-right"></i>
                </button>
            </div>
    ...
    <div class="card rounded-0 border-0 " style="margin-top:-10px">
        ...
        <div class="card-body bg-card-dark-mode">
            <div class="row justify-content-center">
                ...
                <div class="col-1 arrow-desktop text-center">
                    <button class="btn rounded-5 text-white left-button2"
    ...
    <div class="card-body bg-card-dark-mode">
        ...
        <div class="row  mobile-scroll mt-2 align-items-center">
            ...
            <div class="col-1 arrow-desktop text-center">
                <button id="left-button1" class="btn rounded-5 text-white bg-secondary"
                    style="background-color: #61481C">
                    <i class="fa-solid fa-arrow-left"></i>
                </button>
            </div>
                    ...
                    <div class="col-12 custom">
                        <div class="card mb-2 mx-auto">
                            ...
                            <div id="ksl2" class="carousel slide" data-bs-interval="false">
                                <div class="carousel-indicators">
                                    <button type="button" data-bs-target="#ksl2" data-bs-slide-to="0" class="active"
                                        aria-current="true" aria-label="Slide 1"></button>
                            ...
                            <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-items-center">
                                            ...
                                            <div class="row d-flex  align-items-center mb-2">
                                                ...
                                                <div class="col">
                                                    <button class="btn float-end btn-danger mb-0" data-bs-toggle="modal"
                                                        data-bs-target="#exampleA">
                                                        &nbsp;&nbsp;&nbsp;Bid&nbsp;&nbsp;&nbsp;</button>
                                                </div>
                                            </div>
                                            <script>
                                ...
                                <div class="row g-0">
                                    <div class="col text-start">
                                        ...
                                        <a href="#" class="  mx-auto rounded-5" data-bs-toggle="modal"
                                            data-bs-target="#berkasA" style="text-decoration:none">
                                            <i class="fa-solid fa-eye"></i> Lihat Detail
                                        </a>


                                        <div class="modal fade my-auto text-center" id="berkasA" tabindex="-1"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header p-0">
                                ...
                                <div class="row justify-content-center g-0" style="margin-top:-15px;">
                                    <div class="col-4">
                                        ...
                                        <div class="d-grid gap-2 ">
                                            ...
                                            <div class="modal fade my-auto" id="exampleA" tabindex="-1"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header p-0">
                    ...
                    <div class="col-12 custom">
                        <div class="card mb-2 mx-auto">
                            ...
                            <div id="ksl10" class="carousel slide" data-bs-interval="false">
                                <div class="carousel-indicators">
                                    <button type="button" data-bs-target="#ksl10" data-bs-slide-to="0" class="active"
                                        aria-current="true" aria-label="Slide 1"></button>
                    ...
                    <div class="col-12 custom">
                        <div class="card mb-2 mx-auto">
                            ...
                            <div id="ksl3" class="carousel slide" data-bs-interval="false">
                                <div class="carousel-indicators">
                                    <button type="button" data-bs-target="#ksl3" data-bs-slide-to="0" class="active"
                                        aria-current="true" aria-label="Slide 1"></button>
                                ...
                                <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                    data-bs-target="#ksl3" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next opacity-90 text-dark" type="button"
                                    data-bs-target="#ksl3" data-bs-slide="next">
                                    <span class="carousel-control-next-icon bg-dark rounded-circle"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Next</span>
                                </button>
                    ...
                    <div class="col-12 custom">
                        <div class="card mb-2 mx-auto">
                            ...
                            <div id="ksl4" class="carousel slide" data-bs-interval="false">
                                <div class="carousel-indicators">
                                    <button type="button" data-bs-target="#ksl4" data-bs-slide-to="0" class="active"
                                        aria-current="true" aria-label="Slide 1"></button>
                                ...
                                <button class="carousel-control-prev opacity-90 text-dark" type="button"
                                    data-bs-target="#ksl4" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon bg-dark rounded-circle"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next opacity-90 text-dark" type="button"
                                    data-bs-target="#ksl4" data-bs-slide="next">
                                    <span class="carousel-control-next-icon bg-dark rounded-circle"
                                        aria-hidden="true"></span>
                                    <span class="visually-hidden">Next</span>
                                </button>
            ...
            <div class="col-1 arrow-desktop text-center">
                <button id="right-button1" class="btn rounded-5 text-white bg-secondary"
                    style="background-color: #61481C">
                    <i class="fa-solid fa-arrow-right"></i>
                </button>
            </div>
    ...
    <div class="card-body bg-card-dark-mode">
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-1 arrow-desktop text-center">
                <button id="left-button3" class="btn rounded-5 text-white bg-secondary"
                    style="background-color: #61481C;">
                    <i class="fa-solid fa-arrow-left"></i>
                </button>
            </div>
                            ...
                            <div class="card-body pt-0">
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <button class="btn float-end btn-warning text-white mb-0 my-auto w-100"
                                ...
                                <div class="row g-0">
                                    <div class="col text-start">
                                        ...
                                        <a href="#" class="  mx-auto rounded-5" data-bs-toggle="modal"
                                            data-bs-target="#berkasC" style="text-decoration:none">
                                            <i class="fa-solid fa-eye"></i> Lihat Detail
                                        </a>
            ...
            <div class="col-1 arrow-desktop text-center">
                <button id="right-button3" class="btn rounded-5 text-white bg-secondary"
                    style="background-color: #61481C">
                    <i class="fa-solid fa-arrow-right"></i>
                </button>
            </div>
    ...
    <div class="col-1 arrow-desktop justify-content-center">
        <button class="btn rounded-5 text-white right-button3 text-center"
            style="margin-top:200%;background:transparent">
            <i class="fa-solid fa-arrow-right"></i>
        </button>
    ...
    <div class="card rounded-0 border-0 " style="margin-top:-10px">
        ...
        <div class="card-body bg-card-dark-mode">
            <div class="row justify-content-center">
                ...
                <div class="col-1 arrow-desktop text-center">
                    <button class="btn rounded-5 text-white left-button4"
                        style="margin-top:200%;background:transparent">
                        <i class="fa-solid fa-arrow-left"></i>
                    </button>
                </div>
                <div class="col-10">
                    <div class="row mt-0 mobile-scroll justify-content-between scroll-simple align-items-center lelang-card4"
                        style="flex-wrap: nowrap;">
                ...
                <div class="col-1 arrow-desktop justify-content-center">
                    <button class="btn rounded-5 text-white right-button4 text-center"
                        style="margin-top:200%;background:transparent">
                        <i class="fa-solid fa-arrow-right"></i>
                    </button>
        ...
        <div class="card-header bg-white">
            <table style="width:100%">
                <tr>
                    ...
                    <td class="text-end" rowspan="2">
                        <a href="{{url('')}}/podcast-sengketa" class="text-success fw-bold"
                            style="text-decoration: none">Lihat
                            Semua</a>
                    </td>
                </tr>
                ...
                <div class="modal-content border-0" style="background-color:transparent">
                    ...
                    <div class="modal-body d-flex" style="background-color:transparent">
                        <div class="container">
                            ...
                            <div id="carouselExampleIndicators" data-bs-touch="false"
                                class="carousel slide mt-2 desktop" data-bs-ride="false">

                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <figure class="mx-auto zoom" onmousemove="zoom(event)"
                                            style="background-image: url({{asset('')}}images/lahan1.jpeg); background-size: 200%">
                                            <img src="{{asset('')}}images/lahan1.jpeg" onmousemove='zoom(event)'
                                                class="d-block image-kunam-2" alt="...">
                                        </figure>
                                    </div>
                                    <div class="carousel-item">
                                        <figure class="mx-auto zoom" onmousemove="zoom(event)"
                                            style="background-image: url({{asset('')}}images/lahan2.jpeg); background-size: 200%">
                                            <img src="{{asset('')}}images/lahan2.jpeg" onmousemove='zoom(event)'
                                                class="d-block image-kunam-2" alt="...">
                                        </figure>
                                    </div>
                                    <div class="carousel-item">
                                        <figure class="mx-auto zoom" onmousemove="zoom(event)"
                                            style="background-image: url({{asset('')}}images/lahan3.jpeg); background-size: 200%">
                                            <img src="{{asset('')}}images/lahan3.jpeg" onmousemove='zoom(event)'
                                                class="d-block image-kunam-2" alt="...">
                                        </figure>
                                    </div>
                                    <div class="carousel-item">
                                        <figure class="mx-auto zoom" onmousemove="zoom(event)"
                                            style="background-image: url({{asset('')}}images/lahan4.jpeg); background-size: 200%">
                                            <img src="{{asset('')}}images/lahan4.jpeg" onmousemove='zoom(event)'
                                                class="d-block image-kunam-2" alt="...">
                                        </figure>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-indicators custom scroll-simple">
                                    <button type="button" data-bs-target="#carouselExampleIndicators"
                                        ...
                                        <img src="{{asset('')}}images/lahan1.jpeg" class="d-block w-100 image-kunam-2"
                                            alt="...">
                                    </button>
                                    <button type="button" data-bs-target="#carouselExampleIndicators"
                                        data-bs-slide-to="1" aria-label="Slide 2">
                                        <img src="{{asset('')}}images/lahan2.jpeg" class="d-block w-100 image-kunam-2"
                                            alt="...">
                                    </button>
                                    <button type="button" data-bs-target="#carouselExampleIndicators"
                                        data-bs-slide-to="2" aria-label="Slide 3">
                                        <img src="{{asset('')}}images/lahan3.jpeg" class="d-block w-100 image-kunam-2"
                                            alt="...">
                                    </button>
                                    <button type="button" data-bs-target="#carouselExampleIndicators"
                                        data-bs-slide-to="3" aria-label="Slide 4">
                                        <img src="{{asset('')}}images/lahan4.jpeg" class="d-block w-100 image-kunam-2"
                                            alt="...">
                                    </button>
                                </div>
                            ...
                            <div id="carouselExampleIndicatorsM" data-bs-touch="false"
                                class="carousel slide mt-2 mobile" data-bs-ride="false">
                                ...
                                <div class="carousel-indicators custom scroll-simple">
                                    <button type="button" data-bs-target="#carouselExampleIndicatorsM"
                                        data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                                ...
                                <button class="carousel-control-prev" type="button"
                                    data-bs-target="#carouselExampleIndicatorsM" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next" type="button"
                                    data-bs-target="#carouselExampleIndicatorsM" data-bs-slide="next">
                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Next</span>
                                </button>
                            </div>
    ...
    <div class="card-body" style="background-color:#000;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg">
                    <iframe id="vid_frame"
                        src="https://www.youtube.com/embed/-RkCcavzXq8?rel=0&amp;showinfo=0&amp;autohide=1" width="100%"
                ...
                <div class="col-lg-5 vid-lamo" style="height: 320px; overflow-y: scroll">
                    ...
                    <div class="row mb-3 g-0">
                        <div class="row g-2 pencet"
                            onclick="document.getElementById('vid_frame').src='https://youtube.com/embed/-RkCcavzXq8?autoplay=1&amp;rel=0&amp;showinfo=0&amp;autohide=1'">
                    ...
                    <div class="row mb-3 g-0">
                        <div class="row g-2 pencet"
                            onclick="document.getElementById('vid_frame').src='https://youtube.com/embed/byby3HJ3OCI?autoplay=1&amp;rel=0&amp;showinfo=0&amp;autohide=1'">
                    ...
                    <div class="row mb-3 g-0">
                        <div class="row g-2 pencet"
                            onclick="document.getElementById('vid_frame').src='http://youtube.com/embed/byby3HJ3OCI?autoplay=1&amp;rel=0&amp;showinfo=0&amp;autohide=1'">
                            <div class="col-4"><img class="imago" width="100%"
                                    src="https://i.ytimg.com/vi/byby3HJ3OCI/hqdefault.jpg?sqp=-oaymwEcCPYBEIoBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLCHbyFGnyjuYbXClrL-dy7-iFeVOQ">
                            </div>
                            <div class="col-8 text-white texto">Mafia Tanah Sikat Lahan Garapan Petani
                ...
                <div class="modal-content border-0" style="background-color:transparent">
                    ...
                    <div class="modal-body d-flex" style="background-color:transparent">
                        <div class="container">
                            ...
                            <div id="carouselExampleIndicators2" data-bs-touch="false"
                                class="carousel slide mt-2 desktop" data-bs-ride="false">
                                ...
                                <div class="carousel-indicators custom scroll-simple">
                                    <button type="button" data-bs-target="#carouselExampleIndicators2"
                                        data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                                        <img src="{{asset('')}}images/rm1.jpg" class="d-block w-100 image-kunam-2"
                                            alt="...">
                                    </button>
                                    <button type="button" data-bs-target="#carouselExampleIndicators2"
                                        data-bs-slide-to="1" aria-label="Slide 2">
                                        <img src="{{asset('')}}images/rm2.jpg" class="d-block w-100 image-kunam-2"
                                            alt="...">
                                    </button>
                                    <button type="button" data-bs-target="#carouselExampleIndicators2"
                                        data-bs-slide-to="2" aria-label="Slide 3">
                                        <img src="{{asset('')}}images/rm3.jpg" class="d-block w-100 image-kunam-2"
                                            alt="...">
                                    </button>
                                    <button type="button" data-bs-target="#carouselExampleIndicators2"
                                        data-bs-slide-to="3" aria-label="Slide 4">
                                        <img src="{{asset('')}}images/rm4.jpg" class="d-block w-100 image-kunam-2"
                                            alt="...">
                                    </button>
                                </div>
                            ...
                            <div id="carouselExampleIndicators2M" data-bs-touch="false"
                                class="carousel slide mt-2 mobile" data-bs-ride="false">
                                ...
                                <div class="carousel-indicators custom scroll-simple">
                                    <button type="button" data-bs-target="#carouselExampleIndicators2M"
                                        data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                                ...
                                <button class="carousel-control-prev" type="button"
                                    data-bs-target="#carouselExampleIndicators2M" data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next" type="button"
                                    data-bs-target="#carouselExampleIndicators2M" data-bs-slide="next">
                                    <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Next</span>
                                </button>
                            </div>
