...
<body>
    ...
    <div class="container">
        ...
        <div class="row g-2 mt-2 desktop">
            ...
            <div class="col-auto">
                <a class="btn" style="background-color: #A47E3B; color: #fff" href="{{url('')}}/join">Pelajari Jasa Ukur</a>
            </div>
        ...
        <div class="row g-0 justify-content-center">
            ...
            <div class="col mobile" style="margin-top:5px">
                <div class="ms-1 d-grid gap-2">
                    <a class="btn btn-sm fw-bold btn-outline-brownie rounded-5" href="{{url('')}}/join">Pelajari Petugas Ukur</a>
                </div>
            </div>
        </div>
