                ...
                <div class="card mb-4 border-0 shadow-sm ">
                    ...
                    <div class="card-body" style="background-color:#F6D471">
                        <div class="card" style="width: 18rem;">
                            <img src="{{asset('')}}images/pertanahan.jpg" class="card-img-top" alt="..."
                        ...
                        <div class="col-md">
                            <div class="card-body text-center container" style="height:500px">
                                ...
                                <div class="card rounded-0"
                                    style="width: 17rem; position:relative; left:50%;transform: translate(-50%, -50%);">
                                    <div class="card-body">
                                        <p class="card-text">"Sesuai perintah Bapak Presiden, semua kasus mafia tanah
                                            yang ada
                                            di
                                            Indonesia harus
                        ...
                        <div class="col-md">
                            <div class="card-body text-center container" style="height:500px">
                                ...
                                <div class="card rounded-0"
                                    style="width: 17rem; position:relative; left:50%;transform: translate(-50%, -50%);">
                                    <div class="card-body">
                                        <p class="card-text">"Penyidik tidak perlu ragu ragu dalam mengusut tuntas
                                            masalah mafia
                                    ...
                                    <div class="card rounded-0"
                                        ...
                                        <div class="card-body">
                                            <p class="card-text">"Presiden Joko Widodo menegaskan kepada Kementerian
                                                ATR/BPN
                                                untuk
                                                serius dalam memberantas mafia tanah" <br> -<b> Ir. H. Joko Widodo
                                                    (Presiden
                                                    RI)</b>
                                            </p>
                                        </div>
                                    ...
                                    <div class="card rounded-0"
                                        ...
                                        <div class="card-body">
                                            <p class="card-text">"Penyidik tidak perlu ragu ragu dalam mengusut tuntas
                                                ...
                                                tanah, penyidik agar tindak tegas siapapun dalang dan bekingannya" <br>
                                                -<b>
                                                    Listyo
                                                    Sigit Prabowo (Kapolri) </b>
                                            </p>
                ...
                <!-- <form action="">
                    <div class="row">
                        <div class="col">
                            <div class="mb-1">
                                <div class="dropdown">
                                    <button class="btn dropdown-toggle text-white w-100 rounded-0"
                                        style="background: #06ad5f" type="button" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                        Pilih Layanan Lain
                                    </button>
