                            ...
                            <div class=" mb-3">
                                <center>
                                    <div class="row g-0">
                                        ...
                                        <!-- <div class="col mt-2">
                                            <a class="tab btn btn-outline-secondary rounded-0 active" style="width:100%;border:1px solid rgba(146,111,52,1)  " id="btnSponsor">Sponsor </a>
                                        </div>
                                        <div class="col mt-2">
                                            <a class="tab btn btn-outline-secondary rounded-0" style="width:100%;border:1px solid #581845" id="btnPemerintah" id="btnPemerintah">Pemerintah</a>
                                        </div> -->
                                    </div>
                                </center>
                            </div>
                                        ...
                                        <div class="card mb-2">
                                            ...
                                            background: #8f8f8f">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <h5 class="mb-0 text-center">Kode Bid {{$bs['kode']}} <img src="{{url('/')}}/uploads/biru_centang.png" alt="" class="mb-1" style="height:20px"></h4>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mobile">
                                                <div id="carouselmobile{{$bs['id']}}" class="carousel slide" data-bs-ride="carousel">
                                                    <div class="carousel-indicators">
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col text-center">
                                                    <span onclick="return document.querySelector('form.form-sengketa<?= $bs['id'] ?>').submit()" class="btn btn-success rounded-5" style="cursor:pointer"><i class="fa-solid fa-play text-danger"></i> Lihat
                                                        Podcast</span>
                                                </div>
                                            </div>
