...
<body>
    ...
    <div class="container">
        ...
        <div class="row mt-2" style="padding: 10px">
            <div class="card p-0 rounded-3 shadow-sm">
                    ...
                    <div class="row g-0">
                        <div class="col-4 text-center mb-2">
                            ...
                            <img  src="{{asset('/')}}images/panduan.svg" alt=""
                                ...
                                <h6 class="mt-2 mb-1" style="font-weight:400;">PANDUAN</h6>
                        ...
                        <div class="col-4  text-center mb-2">
                            ...
                            <img  src="{{asset('/')}}images/jaminan.svg" alt=""
                                ...
                                <h6 class="mt-2 mb-1" style="font-weight:400;">JAMINAN</h6>

                        </div>
                        <div class="col-4  text-center mb-2">
                            <img  src="{{asset('/')}}images/jaminan.svg" alt=""
                                class="img-thumbnail rounded-circle shadow" style="border: 2px solid white;width:100px;height:100px;object-fit:cover">
                                <h6 class="mt-2 mb-1" style="font-weight:400;">TENTANG</h6>
                        </div>
                    </div>
